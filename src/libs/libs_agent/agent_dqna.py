...
class DQNAAgent(libs_agent.Agent):
    def __init__(self, env, network_config_path, gamma, replay_buffer_size, epsilon_training = 0.2, epsilon_testing = 0.01, epsilon_decay = 1.0):
        ...
        features_network_config_file_name = network_config_path + "features_network_config.json"
        reconstruction_network_config_file_name = network_config_path + "reconstruction_network_config.json"
        q_network_config_file_name = network_config_path + "q_network_config.json"

        #this is true magic of deep RL, deep Q network
        self.deep_q_network = DQNA(state_shape, self.env.get_actions_count(), gamma, replay_buffer_size, features_network_config_file_name, reconstruction_network_config_file_name, q_network_config_file_name)
